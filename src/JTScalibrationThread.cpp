...
_inputPortName_idyn_RA(inputPortName_idyn_RA),
_inputPortName_idyn_LA(inputPortName_idyn_LA),
_inputPortName_idyn_RL(inputPortName_idyn_RL),
_inputPortName_idyn_LL(inputPortName_idyn_LL),
_inputPortName_idyn_T(inputPortName_idyn_T),
